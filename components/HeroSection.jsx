      ...
      <div className="grid grid-cols-1 md:grid-cols-12 ">
          ...
          >
            <h1 className="font-extrabold">
              ...
              <TypeWritter
                ...
                onInit={(typewriter) => {
                    ...
                    .pauseFor(1500)
                    .deleteAll()
                    .typeString`<span style="color:#9E7BFF">Data Analyst</span>`
                    .pauseFor(1500)
                    .deleteAll()
                    .start();
            ...
            <p className="text-gray-300 pt-8 text-base sm:text-lg mb-6 lg:text-xl">
              ...
              <Link
                href="https://drive.google.com/file/d/1fvTURMbcrSaH8ua3QFrK54p7V0Ck-2nb/view?usp=sharing"
        ...
        <div className="col-span-4 md:col-span-4 place-self-center mt-12 lg:mt-0 pt-0 lg:pt-24">
          ...
          <div className="w-[400px] h-[400px] relative z-0">
            <Image src="/Hero-Section.png" alt="hero section"
