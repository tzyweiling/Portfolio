        ...
        <main className="grid md:grid-cols-2 my-12 md:my-12 py-24 md:py-24 gap-4 relative" id="contact">
            <div className="z-10">
                ...
                <div className=" flex flex-row gap-4 mt-6">
                    <Link href="https://github.com/tzyweiling">
                        <Image src={GithubIcon} alt="Github Icon" />
                    </Link>
                    <Link href="https://www.linkedin.com/in/tzy-wei-ling-8344a5295/">
                        <Image src={LinkedinIcon} alt="Linkedin Icon" />
                    </Link>
                    <Link href="https://www.instagram.com/tzyweiling/" className="mt-1">
                        <Image src={InstagramIcon} alt="Instagram Icon" />
                    </Link>
                    <Link href="mailto:lingtzywei1114@gmail.com" className="mt-1">
